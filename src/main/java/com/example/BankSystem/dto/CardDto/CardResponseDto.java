...
public class CardResponseDto {
    ...
    public CardResponseDto(Long id, CardType cardType, Issuer issuer, Double balance, String cardNumber, LocalDate expirationDate, String cvcCode, CardStatus cardStatus, String pin) {
        this.id = id;
